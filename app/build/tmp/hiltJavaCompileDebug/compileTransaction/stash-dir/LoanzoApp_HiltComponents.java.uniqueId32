...
import com.loanzo.app.di.DatabaseModule;
import com.loanzo.app.di.NetworkModule;
...
public final class LoanzoApp_HiltComponents {
  private LoanzoApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements LoanzoApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          FinancialHealthViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          FinancialHealthViewModel_HiltModules.BindsModule.class,
