...
data class AgentApplicationEntity(
    ...
    val experienceYears: String = "1-2 Years", // "1-2 Years", "3-5 Years", "5+ Years"
    val priorDomain: String = "Banking / NBFC", // "Banking / NBFC", "Microfinance (MFI)", "Gold Loan Valuer", "Real Estate & Vehicle Appraiser", "Legal Recovery"
    ...
    val vehicleType: String = "Two-Wheeler", // "Two-Wheeler", "Four-Wheeler", "Public Transit"
